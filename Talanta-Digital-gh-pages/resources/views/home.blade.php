...
@section('content')
    <div class="container-fluid">
        <div id="adminActions" class="d-none row py-2">
            <nav id="asideMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        ...
        {{-- Students --}}
        <div class="py-2">
            <div class="card d-none" id="studentForms">
                <div class="card-header">
                    <button class="btn inline-flex px-2" id="course-register-button">
                        Course Registration
                    </button>
                    <button class="btn inline-flex px-2" id="profile-update">
                        Profile Update
                    </button>
                </div>
    ...
    <script>
        window.addEventListener('load', () => {
            axios.post('/role/check').then((response) => {
                if (response.data.user_type === 'admin') {
                    document.getElementById('adminActions').classList.remove('d-none');
                } else {
                    document.getElementById('studentForms').classList.remove('d-none');
                }
            })
        });
    </script>
